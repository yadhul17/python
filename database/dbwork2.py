...
while True:
     ...
     if ch==3:
         ...
         print("{:<10}{:<10}{:<10}{:<12}{:<15}{:<10}{:<10}".format('id','name','city','bloodgroup','phoneno','weight','age'))
         for i in data:
           print("{:<10}{:<10}{:<10}{:<12}{:<15}{:<10}{:<10}".format (i[0],i[1],i[2],i[3],i[4],i[5],i[6]))
     if ch==2:
         while True:
             print(''''1.name
                   2.city
             ...
             if c==1:
              ...
              cur.execute("update blood set name=? where id=?",(newname,idno))
              con.commit()
             if c==2:
              idno=int(input("enter the id to update:"))
              newcity=input("enter a new city name:")
              cur.execute("update blood set city=? where id=?",(newcity,idno))
              con.commit()
             if c==3:
              idno=int(input("enter the id to update:"))
              newbg=input("enter a new blood group:")
              cur.execute("update blood set bloodgroup=? where id=?",(newbg,idno))
              con.commit()
             if c==4:
              idno=int(input("enter the id to update:"))
              newno=int(input("enter a new name:"))
              cur.execute("update blood set phoneno=? where id=?",(newno,idno))
              con.commit()
             if c==5:
              idno=int(input("enter the id to update:"))
              newweight=int(input("enter a new weight:"))
              cur.execute("update blood set weight=? where id=?",(newweight,idno))
              con.commit()
             if c==6:
              idno=int(input("enter the id to update:"))
     ...
     if ch==4:
        while True:
           ...
           if cho==1:
             ...
             d=cur.fetchall()
             print("{:<10}{:<10}{:<10}{:<15}{:<12}{:<10}{:<10}".format('id','name','city','bloodgroup','phoneno','weight','age'))
             for i in d:
                 print("{:<10}{:<10}{:<10}{:<15}{:<12}{:<10}{:<10}".format (i[0],i[1],i[2],i[3],i[4],i[5],i[6]))
           if cho==2:
             bloodg=input("enter bloodgroup:")
            
            
             cur.execute("select * from blood where bloodgroup=?",(bloodg,))
             d=cur.fetchall()
             print("{:<10}{:<10}{:<10}{:<15}{:<12}{:<10}{:<10}".format('id','name','city','bloodgroup','phoneno','weight','age'))
             if not d:
                print("no doners")
